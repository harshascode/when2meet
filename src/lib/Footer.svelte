<script>
  ...
  <footer class="site-footer bg-[#26272b] text-[#737373] text-sm leading-6">
	<div class="container mx-auto px-4 py-6 md:py-8">
	  <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
		<!-- About Section -->
		<div>
		  <h6 class="mb-4 text-base font-semibold uppercase tracking-wider text-white">About</h6>
		...
		<!-- Quick Links -->
		<div class="md:pl-8">
		  <h6 class="mb-4 text-base font-semibold uppercase tracking-wider text-white">Quick Links</h6>
		  <ul class="grid grid-cols-2 gap-2">
			<li>
			  <a 
				href="/" 
				class="hover:text-[#3366cc] transition-colors duration-200"
			  >
				Create Event
			  </a>
			</li>
	  ...
	  <div class="flex flex-col items-center gap-4 md:flex-row md:justify-between">
		<p class="text-center md:text-left">
		  Copyright &copy; {currentYear} <a href="/" class="hover:text-[#3366cc]">When2meet</a>. 
		  All Rights Reserved.
		</p>
